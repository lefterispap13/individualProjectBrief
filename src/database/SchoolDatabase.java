...
public class SchoolDatabase {
    ...
    static{
        ...
        Assignment java5=new Assignment("project5","school management",Utilities.newDate("29/01/2021"));
        Assignment csharp1=new Assignment("project1","private school",Utilities.newDate("13/11/2021"));
        Assignment csharp2=new Assignment("project2","bank account",Utilities.newDate("17/12/2021"));
        Assignment csharp3=new Assignment("project3","login system",Utilities.newDate("17/01/2021"));
        Assignment csharp4=new Assignment("project4","pc structure",Utilities.newDate("17/02/2021"));
        Assignment csharp5=new Assignment("project5","school management",Utilities.newDate("29/10/2021"));
        ...
        AssignmentPerStudent lefterisAssign1=new AssignmentPerStudent(java1,Utilities.newDate("16/11/2020"),"90","HIGH PASS");
        AssignmentPerStudent lefterisAssign2=new AssignmentPerStudent(java2,Utilities.newDate("17/12/2020"),"80","HIGH PASS");
        AssignmentPerStudent lefterisAssign3=new AssignmentPerStudent(java3,Utilities.newDate("16/01/2021"),"70","PASS");
